...
def plot_averaged_spectrum(filename):
    with h5py.File(filename, "r") as file:
        wavelengths = file["wavelengths"][:]
...
def main():
    try:
        ...
        filename_averaged_spectra = "./.h5 files/averaged_2023-09-04.h5"
        plot_averaged_spectrum(filename_averaged_spectra)
        
        filename_individual_spectra = "./.h5 files/2023-09-04.h5"
        plot_individual_spectra(filename_individual_spectra)
        
        filename_individual_spectra_timestamps = "./.h5 files/2023-09-04.h5"
        target_wavelength = 633  
        extract_and_plot_intensity_vs_time(filename_individual_spectra_timestamps, target_wavelength)
        
        filename_individual_spectra_timestamps = "./.h5 files/2023-09-04.h5"
        start_wavelength = 600
        end_wavelength = 650   
        num_points = 5
        extract_and_plot_intensity_vs_time_range(filename_individual_spectra_timestamps, start_wavelength, end_wavelength, num_points)
