...
plt.xlabel('Time Since Start (seconds)', fontsize=14, fontweight="bold")
...
pd.DataFrame(data_wl_wavelength).to_csv(DIRPATH + '//' + "KagomeACN_Wavelength.csv", header=None, index=None)
