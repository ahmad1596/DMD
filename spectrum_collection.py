...
closest_wavelength_index = np.argmin(np.abs(df_measured['Wavelength'] - input_wavelength))
closest_wavelength = df_measured.loc[closest_wavelength_index, 'Wavelength']
scaled_factor = power_percentage / df_measured.loc[closest_wavelength_index, 'Intensity_1']
df_measured['Percentage_Transmission_1'] = df_measured['Intensity_1'] * scaled_factor
df_filtered_1 = df_measured[(df_measured['Wavelength'] > 400)] #& (df_measured['Wavelength'] < 1000)]
...
closest_wavelength_index = np.argmin(np.abs(df_measured['Wavelength'] - input_wavelength))
closest_wavelength = df_measured.loc[closest_wavelength_index, 'Wavelength']
scaled_factor = power_percentage / df_measured.loc[closest_wavelength_index, 'Intensity_2']
df_measured['Percentage_Transmission_2'] = df_measured['Intensity_2'] * scaled_factor
df_filtered_2 = df_measured[(df_measured['Wavelength'] > 400)] #& (df_measured['Wavelength'] < 1000)]
...
closest_wavelength_index = np.argmin(np.abs(df_measured['Wavelength'] - input_wavelength))
closest_wavelength = df_measured.loc[closest_wavelength_index, 'Wavelength']
scaled_factor = power_percentage / df_measured.loc[closest_wavelength_index, 'Intensity_3']
df_measured['Percentage_Transmission_3'] = df_measured['Intensity_3'] * scaled_factor
df_filtered_3 = df_measured[(df_measured['Wavelength'] > 400)] #& (df_measured['Wavelength'] < 1000)]
...
closest_wavelength_index = np.argmin(np.abs(df_measured['Wavelength'] - input_wavelength))
closest_wavelength = df_measured.loc[closest_wavelength_index, 'Wavelength']
scaled_factor = power_percentage / df_measured.loc[closest_wavelength_index, 'Intensity_4']
df_measured['Percentage_Transmission_4'] = df_measured['Intensity_4'] * scaled_factor
df_filtered_4 = df_measured[(df_measured['Wavelength'] > 400)] #& (df_measured['Wavelength'] < 1000)]
...
closest_wavelength_index = np.argmin(np.abs(df_measured['Wavelength'] - input_wavelength))
closest_wavelength = df_measured.loc[closest_wavelength_index, 'Wavelength']
scaled_factor = power_percentage / df_measured.loc[closest_wavelength_index, 'Intensity_5']
df_measured['Percentage_Transmission_5'] = df_measured['Intensity_5'] * scaled_factor
df_filtered_5 = df_measured[(df_measured['Wavelength'] > 400)] #& (df_measured['Wavelength'] < 1000)]
